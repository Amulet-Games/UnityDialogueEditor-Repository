...
namespace AG
{
    public static class CSVHelper
    {
        ...
        public static List<DialContainerSO> FindAllDialogueContainerSO()
        {
            ...
            DialContainerSO[] containerSOs = new DialContainerSO[guidsLength];
            ...
            for (int i = 0; i < guidsLength; i++)
            {
                ...
                containerSOs[i] = AssetDatabase.LoadAssetAtPath<DialContainerSO>(path);
            }
